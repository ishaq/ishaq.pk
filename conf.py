...
BLOG_AUTHOR = {"ur": "محمد اسحاق", "en": "Muhammad Ishaq"} # (translatable)
BLOG_TITLE = {"ur": "اسحاق ڈاٹ پی کے", "en": "ishaq.pk"}  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://ishaq.pk/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://ishaq.pk/"
BLOG_EMAIL = "ishaq@kahaf.com"
BLOG_DESCRIPTION = {"ur": "پروگرامنگ سے متعلق یاداشتیں", "en": "My notes about my work"}# (translatable)
